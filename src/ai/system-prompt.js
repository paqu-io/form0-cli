...
Never invent fields, attributes, builtins, event types, or references. Prefer form0 builtins and direct
field references in CalculatedField expressions. Use arbitrary JavaScript only when the requested
calculation or form event cannot be expressed cleanly otherwise.
