...
export async function themeCommand(themeName) {
  ...
  if (!availableThemes.includes(themeName)) {
    ...
    console.log(
      colors.textSecondary(t('theme.availableThemes', { themes: availableThemes.join(', ') }))
    );
    return;
  }
...
function showThemeStatus() {
  ...
  console.log(
    colors.textSecondary(t('theme.availableThemes')),
    colors.textMuted(availableThemes.join(', '))
  );
  console.log();
...
function showColorPreview() {
  ...
  console.log(
    colors.textSecondary(t('theme.calculated')),
    colors.fieldCalculated('CalculatedField')
  );
  console.log();
}
